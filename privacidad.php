...
<main class="flex-grow pt-24 pb-28 md:pb-16 w-full relative md:ml-64 transition-all duration-300 max-w-[1600px] mx-auto">
  ...
  <div class="w-full max-w-4xl mx-auto px-4 md:px-8 mt-6">
    ...
    <div class="text-center mb-10 border-b border-gray-100 pb-8 animate__animated animate__fadeIn">
      ...
      <p class="text-gray-500 font-medium">Última actualización: 08/03/2026</p>
    </div>
        ...
        <div class="space-y-10 text-gray-700 leading-relaxed">
            ...
            <section>
                ...
                <p class="ml-1 md:ml-13 text-gray-600">
                    En Nubira valoramos profundamente la privacidad de nuestros estudiantes. La información que proporcionas al registrarte, como tu correo institucional y nombre, se utiliza exclusivamente para validar tu identidad dentro del ecosistema universitario y mantener una comunidad segura. No vendemos ni compartimos tu información personal con terceros.
                </p>
            </section>
            ...
            <section>
                ...
                <ul class="list-disc pl-5 md:pl-16 space-y-2 text-gray-600 marker:text-[#54A6D8]">
                    <li><strong>Datos de cuenta:</strong> Nombre, correo institucional, universidad y foto de perfil.</li>
                    <li><strong>Actividad en la plataforma:</strong> Historial de compras, apuntes subidos y búsquedas, utilizados para mejorar nuestras recomendaciones mediante IA.</li>
                    <li><strong>Mensajes:</strong> Los chats internos están encriptados y solo son accesibles por los participantes involucrados o por soporte en caso de denuncias explícitas.</li>
                </ul>
            </section>
            ...
            <section>
                ...
                <p class="ml-1 md:ml-13 text-gray-600">
                    Utilizamos cookies esenciales para mantener tu sesión activa (Auto-Login) y cookies analíticas para entender cómo navegas por la plataforma, lo que nos permite mejorar la velocidad y la interfaz. Puedes gestionar tus preferencias de cookies desde la configuración de tu navegador.
                </p>
            </section>
            ...
            <section>
                ...
                <p class="ml-1 md:ml-13 text-gray-600">
                    Toda la información financiera (tarjetas de crédito, cuentas bancarias) es procesada por plataformas de pago certificadas externas. Nubira <strong>no almacena</strong> números de tarjeta ni claves bancarias en sus servidores.
                </p>
            </section>
            ...
            <section>
                ...
                <p class="ml-1 md:ml-13 text-gray-600">
                    Tienes el derecho a solicitar una copia de tus datos o exigir la eliminación permanente de tu cuenta (derecho al olvido). Para ejercer este derecho, escríbenos a <a href="mailto:privacidad@nubira.cl" class="text-[#54A6D8] font-semibold hover:underline">privacidad@nubira.cl</a>.
                </p>
            </section>
