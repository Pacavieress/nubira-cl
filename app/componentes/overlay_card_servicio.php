...
<div class="absolute left-3 z-10 pr-2 leading-tight" style="top:50%; transform:translateY(-50%); max-width:70%;">
    ...
    <div class="flex items-center gap-2 mt-1 text-white <?= $ov_cls_titulo ?> font-bold" style="text-shadow:0 1px 3px rgba(0,0,0,0.6);">
        ...
        <span class="truncate"><?= htmlspecialchars($ov_nombre) ?></span>
    </div>
</div>
