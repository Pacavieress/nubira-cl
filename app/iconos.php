...
function icon($name, $classes = "w-6 h-6") {
    ...
    switch ($name) {
        ...
        case 'instagram': return "<svg $outline class='$classes'><rect x='2' y='2' width='20' height='20' rx='5' ry='5' /><path d='M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z' /><circle cx='17.5' cy='6.5' r='0.5' fill='currentColor'/></svg>";
