...
<aside class="w-60 bg-white border-r p-6 hidden md:flex flex-col justify-between sticky top-0 h-screen overflow-auto">
  <div>
    <h2 class="text-2xl font-extrabold mb-4 text-blue-700">Vitrina de Apuntes</h2>
    <ul class="space-y-3 text-sm">
      <li><a href="/vitrina" class="text-blue-600 hover:underline inline-flex items-center gap-2">Volver Atrás</a></li>
    </ul>
  </div>
