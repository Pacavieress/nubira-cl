...
<aside class="w-60 bg-white border-r p-6 hidden md:flex flex-col justify-between sticky top-0 h-screen overflow-auto">
  <div>
    <h2 class="text-2xl font-extrabold mb-4 text-blue-700">Mi Panel</h2>
    <ul class="space-y-3 text-sm">
      <li><a href="/vitrina" class="text-blue-600 hover:underline inline-flex items-center gap-2">Inicio</a></li>
      <li><a href="/mis_archivos_subidos" class="text-blue-600 hover:underline inline-flex items-center gap-2">Mis Archivos Subidos</a></li>
      <li><a href="/mis_compras" class="text-blue-600 hover:underline inline-flex items-center gap-2">Mis Compras</a></li>
      <li><a href="/mis_ventas" class="text-blue-600 hover:underline inline-flex items-center gap-2">Mis Ventas</a></li>
      <li><a href="/formulario_subir_apunte" class="text-blue-600 hover:underline inline-flex items-center gap-2">Subir Nuevo Apunte</a></li>
      <li><a href="/publicar_empleo" class="text-blue-600 hover:underline inline-flex items-center gap-2">Publicar Empleo</a></li>
      <li><a href="/crear_emprendimiento" class="text-blue-600 hover:underline inline-flex items-center gap-2">Publicar Emprendimiento o Proyecto</a></li>
